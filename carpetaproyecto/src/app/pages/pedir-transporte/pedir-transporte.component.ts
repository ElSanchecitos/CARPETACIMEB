...
@Component({
  selector: 'app-pedir-transporte',
  templateUrl: './pedir-transporte.component.html',
  styleUrls: ['./pedir-transporte.component.css']
})
export class PedirTransporteComponent implements OnInit {
